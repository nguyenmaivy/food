...
public class test_donhang {
    public static void main(String[] args) {
        ...
        // phan phuong thuc thanh toan(khong can thiet, co the bo danh sach phuong thuc
        // thanh toan)
        ...
        // test file
        // danhsachDonHang.nhapDanhSach();
        // danhsachDonHang.docfile("danhsachdonhang_doc.txt");
        // danhsachDonHang.ghifile("danhsachdonhang_ghi.txt");
        // danhsachDonHang.xuatDanhSach();

        // danhsachKhachHang.ghifile("C:\\Sach_OOP\\final0\\khachhang_ghi.txt");
        // danhsachKhachHang.xuatDanhSach();
    }
}
