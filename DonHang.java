...
public class DonHang {
        ...
        switch (luaChon) {
            ...
            case 7:
                if (this.phuongThucThanhToan != null) {
                    System.out.println(
                            "Thong tin phuong thuc thanh toan truoc khi sua: " + this.phuongThucThanhToan.xuat());
                    this.phuongThucThanhToan.suaThongTinPhuongThuc();
                    System.out.println(
                            "Thong tin phuong thuc thanh toan sau khi sua: " + this.phuongThucThanhToan.xuat());
                } else {
    ...
    public String xuat() {
        ...
        return String.format(
                "|ID don hang: %-5s|Trang thai: %-10s|Ngay dat: %tD|Ngay giao: %tD|Phi giao: %.2f %s %s %s",
