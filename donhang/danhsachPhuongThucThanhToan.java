...
public class danhsachPhuongThucThanhToan {
    ...
    public static void nhapPhuongThucThanhToan(Scanner scanner) {
    ...
    public static void xuatDanhSachPhuongThuc() {
    ...
    if (danhSachPhuongThucThanhToan == null) {
        ...
        i = soLuong;
        danhSachPhuongThucThanhToan = Arrays.copyOf(danhSachPhuongThucThanhToan, danhSachPhuongThucThanhToan.length + 1);
    }
