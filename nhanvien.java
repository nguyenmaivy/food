...
public abstract class nhanvien extends ConNguoi {
    ...
    public boolean setMaNV(String maNV) {
        if (maNV != null && !maNV.isEmpty()) {
            ...
            System.err.println("Moi nhap lai ma nhan vien: ");
            return false;
        }
    }
        ...
        switch (luachon) {
            ...
            case 6:
                while (!exitLoop) {
                    ...
                    if (newluong.matches("\\d+\\d*\\.?\\,?") && Double.parseDouble(newluong) != this.luong
    ...
    public void capnhatnhanvien(String ten, int tuoi, String gioitinh, String chucVu, double luong, int trangthai,
            String maNV) {
        this.setMaNV(maNV);
        this.setTen(ten);
        this.setTuoi(tuoi);
    ...
    @Override
    public String xuat() {
        return String.format("|MNV: %-15s | %s |Chuc vu: %-15s | Luong: %-13s ", maNV, super.xuat(), chucVu, luong,
                "VND");
    }
