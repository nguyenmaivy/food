...
public class Sach {
	...
	public Sach(String tenSach, String maSach, newTacGia TacGia, newNXB NXB, newNCC NCC, newTheLoai TheLoai,
			double giaban,
	...
	public newNCC getNcc() {
		return NCC;
	}

	public void setNCC(newNCC nCC) {
		NCC = nCC;
	}
	...
	public void suathongtin() {
		...
		System.out.println("5.Sua NCC cua Sach");
		System.out.println("6.Sua The loai Sach");
		System.out.println("7.Sua Gia ban Sach");
		System.out.println("8.Sua So luong Sach");
	...
	public void capnhatSach(String tenSach, String maSach, newTacGia TacGia, newNXB NXB, newNCC NCC, newTheLoai TheLoai,
	...
	public String xuat() {
		return String.format(
				"Ma Sach: %-20s  | Ten Sach: %-25s | Ten Tac gia: %-25s | Ten NXB: %-15s | Ten NCC: %-15s |The loai Sach: %-15s | Gia ban: %,-15.3f%-3s | So luong Sach: %,d",
				maSach, tenSach, TacGia.getTen(), NXB.getTenNXB(), NCC.getTenNCC(), TheLoai.getTenTheLoai(), giaban,
				"VND", soluong);
	}
