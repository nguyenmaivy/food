...
public class danhsachBanHang implements DanhSach {
        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (text.length == 7 && text[1].matches("^TN.*") && Trunglap(text[1]) == null
                    ...
                    if (BanHang[i] == null)
                        BanHang[i] = new newBanHang(i, text[0], text[1], Double.parseDouble(text[3]), 1,
                                text[4],
    ...
    public void ghifile(String filename) {
        try {
            ...
            FileWriter bin = new FileWriter("D:\\java\\java_project\\food\\sach\\BanHang_recyclebin.txt");
            ...
            while (i < BanHang.length && BanHang[i] != null) {
                ...
                if (BanHang[i].trangthai == 1)
                    writefile.write(BanHang[i].getSLBan() + "#" + BanHang[i].getMaNV()
                            + "#" + BanHang[i].getChucVu() + "#"
                            + BanHang[i].getLuong() + "#" + BanHang[i].getTen() + "#" + BanHang[i].getTuoi() + "#"
                            + BanHang[i].getGioitinh() + "\n");

                else
                    bin.write(BanHang[i].getSLBan() + "#" + BanHang[i].getMaNV() + "#"
                            + BanHang[i].getChucVu() + "#"
                            + BanHang[i].getLuong() + "#" + BanHang[i].getTen() + "#" + BanHang[i].getTuoi() + "#"
                            + BanHang[i].getGioitinh() + "\n");
